...
export const metadata: Metadata = {
  ...
  description:
    "Install GetWired, initialize your project, configure your AI provider, and run your first AI-driven chaotic test in minutes.",
  ...
  return (
    <div>
      ...
      <section className="mt-10">
        ...
        <p className="mt-4 font-mono text-xs text-emerald-500/60 leading-relaxed">
          Once installed, you can start using GetWired with just:
        </p>
        <div className="mt-3 rounded-lg border border-emerald-500/20 bg-black/80 p-4 font-mono text-sm text-green-400"
          style={{ boxShadow: "0 0 20px rgba(16, 185, 129, 0.06)" }}>
          <span className="text-emerald-600">$</span> getwired
        </div>
      </section>
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 rounded-lg border border-emerald-500/20 bg-black/80 p-4 font-mono text-sm text-green-400"
          style={{ boxShadow: "0 0 20px rgba(16, 185, 129, 0.06)" }}>
          <span className="text-emerald-600">$</span> getwired init --provider claude-code
        </div>
        <p className="mt-3 font-mono text-xs text-emerald-500/40">
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 rounded-lg border border-emerald-500/20 bg-black/80 p-4 font-mono text-sm text-green-400"
          ...
          <div className="mt-1"><span className="text-emerald-600">$</span> getwired test</div>
        </div>
        <p className="mt-3 font-mono text-xs text-emerald-500/40">
